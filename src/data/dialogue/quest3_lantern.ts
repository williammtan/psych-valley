...
export const Q3: ExchangeMap = namespaced('q3', {
  ...
  round2: exchange('q3.round2', [
    ...
    say('villager_f', 'Second.', { dup: true }),
  ...
  round3: exchange('q3.round3', [
    ...
    cue('tone_reference'),
    // The chorus is deliberately identical. That flatness is the pressure.
    say('tavi', 'Second.', { dup: true }),
    say('villager_a', 'Second.', { dup: true }),
    say('villager_b', 'Second.', { dup: true }),
    say('villager_e', 'Second, same as Tavi.'),
    say('villager_d', 'Second.', { dup: true }),
